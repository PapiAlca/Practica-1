...
ALTER TABLE P3_TRABAJADOR ADD FOREIGN KEY(catID) REFERENCES P3_CAT(ID),
ADD FOREIGN KEY(cotID) REFERENCES P3_COT(ID);

ALTER TABLE P3_CONCSALARIO ADD FOREIGN KEY(conTipo) REFERENCES P3_CONCTIPO(conTipo),
ADD FOREIGN KEY(numContrato) REFERENCES P3_CONTRATO(numContrato);

ALTER TABLE P3_CONTRATO ADD FOREIGN KEY(codContrato) REFERENCES P3_TCONTRATO(codContrato),
ADD FOREIGN KEY(NIF) REFERENCES P3_TRABAJADOR(NIF),
ADD FOREIGN KEY(CIF) REFERENCES P3_EMPRESA(CIF);

ALTER TABLE P3_PERCEPCION ADD FOREIGN KEY(conTipo) REFERENCES P3_CONCTIPO(conTipo),
ADD FOREIGN KEY(numContrato) REFERENCES P3_CONTRATO(numContrato);

ALTER TABLE P3_TRABAJADOR ADD FOREIGN KEY(NIF) REFERENCES P3_TRABAJADOR(NIF),
ADD FOREIGN KEY(numContrato) REFERENCES P3_CONTRATO(numContrato);